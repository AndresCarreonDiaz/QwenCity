...
const SNAP: WorldSnapshot = {
  ...
  audience: [],
  agents: [
    { id: "a", name: "Ana", bio: "Ana runs the bakery.", mood: "neutral", influencedBy: null, action: "opening the shop", planActivity: "work", location: "cafe", top: [] },
    { id: "b", name: "Bo", bio: "Bo reads a lot.", mood: "sad", influencedBy: { handle: "fan", text: "cheer up!" }, action: "reading", planActivity: null, location: "plaza", top: [] },
  ],
  ticker: [
  ...
  relationships: [{ a: "a", b: "b", weight: 2, tone: "steady" }],
